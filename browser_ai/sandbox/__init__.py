...
Example:
    from browser_ai.sandbox import sandbox, SSEEvent, SSEEventType
...
from browser_ai.sandbox.sandbox import SandboxError, sandbox
from browser_ai.sandbox.views import (
	BrowserCreatedData,
	ErrorData,
	ExecutionResponse,
	LogData,
