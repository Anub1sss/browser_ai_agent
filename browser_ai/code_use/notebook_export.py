...
from browser_ai import BrowserSession
from browser_ai.code_use import create_namespace
...
def session_to_python_script(agent: CodeAgent) -> str:
	...
	lines.append('from browser_ai import BrowserSession\n')
	lines.append('from browser_ai.code_use import create_namespace\n\n')
